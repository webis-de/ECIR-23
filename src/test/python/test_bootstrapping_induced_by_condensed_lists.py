...
class TestBootstrappingInducedByCondensedLists(TestCase):
    ...
    def test_no_changes_for_70_quantile_when_all_bootstraps_are_below_condensed(self):
        model = BootstrappingInducedByCondensedLists(0.7, 'm')
        ...
        self.assertEquals([0.3, 1, 0.2, 0.6, 0.1], actual)
        ...
        self.assertEquals([.2, .75, .3, 0.5, 1], actual)
