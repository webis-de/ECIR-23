from pool_bootstrap_util import create_substitute_pools, substitate_pools_with_effectivenes_scores, __rels_for_topic, __bootstraps_for_topic, evaluate_bootstrap, __single_bootstrap
...
def test_creation_of_substitute_pools_for_some_unjudged_documents_02():
    run = TrecRun()
    run.run_data = pd.DataFrame([
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-01', 'rank': 0, 'score': 3000, 'system': 'a'},
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-02', 'rank': 1, 'score': 2999, 'system': 'a'},
...
def test_creation_of_substitute_pools_for_some_unjudged_documents_03():
    run = TrecRun()
    run.run_data = pd.DataFrame([
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-01', 'rank': 0, 'score': 3000, 'system': 'a'},
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-02', 'rank': 1, 'score': 2999, 'system': 'a'},
...
def test_creation_of_substitute_pools_for_some_unjudged_documents_with_many_different_qrels_large_pool():
    run = TrecRun()
    run.run_data = pd.DataFrame([
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-01', 'rank': 0, 'score': 3000, 'system': 'a'},
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-02', 'rank': 1, 'score': 2999, 'system': 'a'},
...
def test_creation_of_substitute_pools_for_some_unjudged_documents_with_many_different_qrels_huge_pool():
    run = TrecRun()
    run.run_data = pd.DataFrame([
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-01', 'rank': 0, 'score': 3000, 'system': 'a'},
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-02', 'rank': 1, 'score': 2999, 'system': 'a'},
    ...
    qrels.qrels_data = pd.DataFrame([
        ...
        {'query': '301', 'q0': 0, 'docid': 'b-2', 'rel': 2},
        {'query': '301', 'q0': 0, 'docid': 'c-2', 'rel': 2},
        {'query': '301', 'q0': 0, 'docid': 'd-2', 'rel': 2},
        {'query': '301', 'q0': 0, 'docid': 'e-2', 'rel': 2},
    ...
    expected = {'301': sorted([
        ...
        json.dumps({'doc-juru-01': 'a-1', 'shared-doc-01': 'b-1'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-1', 'shared-doc-01': 'a-2'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-2', 'shared-doc-01': 'b-2'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-0', 'shared-doc-01': 'a-1'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-1', 'shared-doc-01': 'a-0'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-2', 'shared-doc-01': 'a-0'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-2', 'shared-doc-01': 'a-1'}, sort_keys=True),
    ]), '302': ['{}']}
...
def test_creation_of_substitute_pools_for_some_unjudged_documents_with_many_different_qrels_huge_pool_01():
    run = TrecRun()
    run.run_data = pd.DataFrame([
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-01', 'rank': 0, 'score': 3000, 'system': 'a'},
        {'query': '301', 'q0': 'Q0', 'docid': 'doc-juru-02', 'rank': 1, 'score': 2999, 'system': 'a'},
...
def test_creation_of_substitute_pools_for_some_unjudged_documents_with_many_different_qrels_huge_pool_02():
    ...
    expected = {'301': sorted([
        json.dumps({'doc-juru-01': 'a-0', 'shared-doc-01': 'b-0'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-0', 'shared-doc-01': 'a-2'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'b-1', 'shared-doc-01': 'a-2'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-0', 'shared-doc-01': 'b-1'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'b-1', 'shared-doc-01': 'a-0'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-2', 'shared-doc-01': 'a-0'}, sort_keys=True),
        json.dumps({'doc-juru-01': 'a-2', 'shared-doc-01': 'b-1'}, sort_keys=True),
    ]), '302': ['{}']}
